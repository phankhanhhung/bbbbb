...
- Kho có **141 bài đã xuất bản**, trên 562 scene. Nội dung do tác giả soạn và tự
...
- 3843 test (67 tệp), 128 e2e, golden SVG phủ mọi step có hình.
...
| `algebra` | 36 | cây biểu thức 16 kiểu nút, **80 luật**, và **kiểm tính đúng của từng bước** trên bốn sân: $\mathbb{F}_p$, thực, nguyên, chuỗi luỹ thừa hình thức | **không có bộ giải, không `simplify_all`, không gợi ý bước** (NG-03) — nó kể một chuỗi biến đổi đã biết và tự kiểm, không tìm ra lập luận |
