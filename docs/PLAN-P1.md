...
**Trạng thái (soát lại 2026-08-02):** đang chạy · **9 engine** + lớp ván chơi (M78) · schema **`1.6.0`** (freeze `1.0.0` ngày 2026-08-01, sáu minor sau đó, mỗi minor một migration) · kho **150 bài** đã xuất bản · **3974 test** (69 tệp), e2e **148** · **G-A và G-C đã đóng** ngày 2026-08-01 (§10 ghi đóng bằng gì và rủi ro nào còn lại) · 84 luật đại số, 59 validator, 46 lệnh sandbox trên 9 engine.
