...
**Trạng thái (soát lại 2026-08-02):** đang chạy · **9 engine** + lớp ván chơi (M78) · schema **`1.6.0`** (freeze `1.0.0` ngày 2026-08-01, sáu minor sau đó, mỗi minor một migration) · kho **148 bài** đã xuất bản · **3943 test** (69 tệp), e2e **146** · **G-A và G-C đã đóng** ngày 2026-08-01 (§10 ghi đóng bằng gì và rủi ro nào còn lại) · 83 luật đại số, 60 validator, 46 lệnh sandbox trên 9 engine.
