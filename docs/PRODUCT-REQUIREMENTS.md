...
1. **G-C** — soạn và publish 3–5 bài do **chính tác giả** xác minh, rồi freeze
   schema `1.0.0`. Hôm nay 68 bài đều do máy soạn và người soạn cũng là người
...
| R-12 | **EXP-10 làm lệch 68 bài đang publish** | PRD-12: diff golden phải rỗng, không phải "gần rỗng" |
